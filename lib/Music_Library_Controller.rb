class MusicLibraryController
  ...
  def initialize(path = "./db/mp3s")
    new_music = MusicImporter.new(path).import
  end
  ...
  def list_songs
    ...
    sorted_songs.each.with_index(1) do |song, number|
  ...
  def list_artists
    ...
    sorted_artists.each.with_index(1) do |artist, number|
